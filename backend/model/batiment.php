...
class Batiment extends DbConnect
{
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT batiments.batiment_id, batiments.libele_batiment, batiments.photos, universites.nom AS nom_universite, universites.ville AS ville_universite FROM batiments INNER JOIN universites ON batiments.universite_id = universites.universite_id GROUP BY batiments.universite_id");
            if ($stmt->execute()) {
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT batiments.batiment_id, batiments.libele_batiment, batiments.photos, universites.nom AS nom_universite, universites.ville AS ville_universite FROM batiments INNER JOIN universites ON batiments.universite_id = universites.universite_id WHERE batiments.universite_id = :id");
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT batiments.batiment_id, batiments.libele_batiment, batiments.photos, universites.nom AS nom_universite, universites.ville AS ville_universite FROM batiments INNER JOIN universites ON batiments.universite_id = universites.universite_id WHERE batiments.batiment_id = :id");
