...
class Plainte extends DbConnect
{
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT plaintes.plainte_id, plaintes.sujet, plaintes.date_plainte, universites.nom AS nom_universite, universites.ville AS ville_universite FROM plaintes INNER JOIN universites ON plaintes.universite_id = universites.universite_id GROUP BY plaintes.universite_id");
            if ($stmt->execute()) {
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT plaintes.plainte_id, plaintes.sujet, plaintes.date_plainte, universites.nom AS nom_universite, universites.ville AS ville_universite FROM plaintes INNER JOIN universites ON plaintes.universite_id = universites.universite_id WHERE plaintes.universite_id = :id");
    ...
    {
        try {
            $stmt = $this->dbConnect->prepare("SELECT plaintes.plainte_id, plaintes.sujet, plaintes.description, plaintes.date_plainte, plaintes.photos, etudiants.nom, etudiants.prenom, universites.nom AS nom_universite, universites.ville AS ville_universite FROM plaintes INNER JOIN universites ON plaintes.universite_id = universites.universite_id INNER JOIN etudiants ON plaintes.etudiant_id = etudiants.etudiant_id WHERE plaintes.plainte_id = :id");
