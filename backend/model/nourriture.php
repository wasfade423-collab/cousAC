<?php
    class Nourriture extends DbConnect{
        public function getNourritures(){
            try{
                $stmt = $this->dbConnect->prepare("SELECT nourritures.nourriture_id, nourritures.nom, nourritures.prix_ticket, universites.nom, universtes.ville FROM nourritures INNER JOIN universites ON nourritures.universite_id = universites.universite_id GROUP BY nourritures.universite_id");
                if($stmt->execute()){
        ...
        public function getNourrituresByUniversite($idUniversite){
            try{
                $stmt = $this->dbConnect->prepare("SELECT nourritures.nourriture_id, nourritures.nom, nourritures.prix_ticket, universites.nom, universtes.ville FROM nourritures INNER JOIN universites ON nourritures.universite_id = universites.universite_id WHERE nourritures.universite_id = :id");
        ...
        public function getNourriture($id){
            try{
                $stmt = $this->dbConnect->prepare("SELECT nourritures.nourriture_id, nourritures.nom, nourritures.prix_ticket, nourritures.menu_details, nourritures.moment_repas, universites.nom, universtes.ville FROM nourritures INNER JOIN universites ON nourritures.universite_id = universites.universite_id WHERE nourritures.nourriture_id = :id");
